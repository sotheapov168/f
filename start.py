...
def baliho():
	try:
		...
		print 'ooO--(_)--Ooo'.center(44)
		print ' ' + W
		print ('[*] ' + name.encode('utf-8') + ' [*]').center(44)
		print ' '
...
def info_ga():
  ...
  -------------       -------------------------------------
   ...
   dump_fb			fetching all phone and date of birth from friend list
...
def dump_fb():
	...
	try:
		...
		for i in a['data']:
			...
			try:
				out.write(z['username'] + '#' + z['mobile_phone'] + '#' + z['email'] + '#'+ '#' + z['name'] + '#'+ z['birthday'] + '\n')
